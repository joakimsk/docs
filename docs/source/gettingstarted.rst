...
In addition to standard PCs it has been reported to work on smaller devices like the Raspberry PI, the Microsat Ulari Duo 2, etc.. See an article on how to run it on the Ulari here: 
http://hamlabs.no/2022/03/27/polaric-server-runs-well-on-ulari/
